...
const PACK_DIR_SOURCE = "Pack (Main)";
const PACK_DIR = path.join(BASE_DIR, PACK_DIR_SOURCE, "assets", "minecraft");
...
function indexItems() {
	...
	fs.writeFileSync(path.join(OUTPUT_DIR, "Index_Details_Items.json"), JSON.stringify(indexResult, null, 4), 'utf-8');
