package com.diabloxmj.xpbank; // Appartient au package principal de notre mod
...
public class ModItems {
    ...
    public static void registerModItems() {
        Xpbank.LOGGER.info("Secure item registration for " + Xpbank.MOD_ID); // Envoie un message de suivi de sécurité dans la console
    ...
    private static Item register(String name, String bottleType) {
        // Étape 1 : Crée une clé de registre unique combinant la nature (ITEM) et l'ID complet (ex: xpbank:mj_xpbottle_lvl1)
        ...
        XpBottleItem item = new XpBottleItem(settings, bottleType);
